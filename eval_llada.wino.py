...
class LLaDAEvalHarness(LM):
    ...
    def generate_until(self, requests: list[Instance]):
        """
        Memory-friendly generate_until for WINO / Prophet-style decoding.

        This version avoids:
        1. Dataset.from_list
        2. Dataset.map
        3. Arrow materialization
        4. dill pickling warning caused by LLaDA custom config enum

        It processes lm-eval requests one by one.
        """
        ...
        for req_idx, req in enumerate(tqdm(requests, desc="Generating...")):
            ...
            # Determine answer start position for early exit if needed.
            # Keep this logic for compatibility, although generate_wino.generate
            ...
            # 4. Generate
            # ------------------------------------------------------------
            from generate_wino import generate
